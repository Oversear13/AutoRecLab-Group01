...
class SelectDatasets:
    ...
    selected_datasets: list[
        str
    ]  # A List of dataset identifiers selected for the research task.
...
class ScoreCode:
    ...
    fulfilled: (
        bool  # True if the specified requirement is fulfilled, false otherwise."""
    )
    feedback: (
        str  # Short feedback explaining why the requirement is or isn't fulfilled."""
    )
